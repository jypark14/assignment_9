    ...
    $.data(t, "flexslider", n),
      (f = {
        init: function() {
          (n.animating = !1),
            ...
            (n.groupBoxSelector = n.vars.selector.substr(
              0,
              n.vars.selector.search(" ")
            )),
            (n.slides = $(n.vars.selector, n)),
            (n.groupBox = $(n.groupBoxSelector, n)),
            ...
            "" !== n.vars.controlsgroupBox &&
              (n.controlsgroupBox =
                $(n.vars.controlsgroupBox).length > 0 &&
                $(n.vars.controlsgroupBox)),
            ...
            n.vars.randomize &&
              ...
              n.groupBox.empty().append(n.slides)),
            n.doMath(),
            n.setup("init"),
            n.vars.controlNav && f.controlNav.setup(),
            n.vars.directionNav && f.directionNav.setup(),
            n.vars.keyboard &&
              (1 === $(n.groupBoxSelector).length || n.vars.multipleKeyboard) &&
        ...
        controlNav: {
          ...
          setupPaging: function() {
            ...
            n.controlsgroupBox
              ? $(n.controlsgroupBox).append(n.controlNavScaffold)
          ...
          set: function() {
            ...
            n.controlNav = $(
              "." + i + "control-nav li " + e,
              n.controlsgroupBox ? n.controlsgroupBox : n
            );
          },
          active: function() {
            n.controlNav
        ...
        pausePlay: {
          setup: function() {
            ...
            n.controlsgroupBox
              ? (n.controlsgroupBox.append(e),
                (n.pausePlay = $("." + i + "pauseplay a", n.controlsgroupBox)))
            ...
            v
              ...
              n.transitions
                ? ((n.vars.animationLoop && n.atEnd) ||
                  ...
                  n.groupBox.unbind("webkitTransitionEnd transitionend"),
                  n.groupBox.bind(
      ...
      (n.setProps = function(e, t, a) {
        ...
        n.transitions &&
          ...
          n.groupBox.css("-" + n.pfx + "-transition-duration", a),
          n.groupBox.css("transition-duration", a)),
          (n.args[n.prop] = i),
          (n.transitions || void 0 === a) && n.groupBox.css(n.args),
          n.groupBox.css("transform", i);
      }),
      (n.setup = function(e) {
        if (p)
          n.slides.css({
          ...
          "init" === e &&
            ...
            n.vars.animationLoop &&
              ...
              ((n.cloneCount = 2),
              (n.cloneOffset = 1),
              "init" !== e && n.groupBox.find(".clone").remove(),
              n.groupBox
                .append(
                  f
                    .uniqueID(
            ...
            d && !v
              ...
              : (n.groupBox.width(200 * (n.count + n.cloneCount) + "%"),
